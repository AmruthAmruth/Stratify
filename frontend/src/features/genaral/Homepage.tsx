...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#fbfbfb] relative overflow-hidden mt-6">
      {/* Background Elements */}
  ...
  >
    ...
    <div className="space-y-4 sm:space-y-6">
      <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-tight text-balance">
        <span className="block text-[#3b3b3b] mb-1 sm:mb-2 animate-slide-up">Transform Your</span>
        <span
          className="block text-[#009063] mb-1 sm:mb-2 animate-slide-up"
      ...
      <p
        className="text-lg sm:text-xl lg:text-2xl text-[#3b3b3b]/80 max-w-3xl mx-auto leading-relaxed font-normal animate-fade-in"
    ...
    >
      <button className="group relative bg-[#009063] text-white px-8 sm:px-12 py-4 sm:py-5 rounded-2xl font-bold text-lg sm:text-xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 overflow-hidden w-full sm:w-auto">
      ...
      <button className="group flex items-center justify-center space-x-3 bg-white border-2 border-[#dfdcef] text-[#3b3b3b] px-8 sm:px-12 py-4 sm:py-5 rounded-2xl font-bold text-lg sm:text-xl shadow-lg hover:shadow-xl hover:border-[#009063] transition-all duration-300 transform hover:scale-105 w-full sm:w-auto">
    ...
    <div
      className="flex flex-wrap justify-center gap-3 sm:gap-4 lg:gap-6 text-[#3b3b3b] animate-fade-in"
