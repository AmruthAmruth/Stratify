...
export const Navbar = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-[#fbfbfb]/95 backdrop-blur-md border-b border-[#dfdcef] shadow-lg p-5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="w-10 h-10 bg-[#009063] rounded-xl flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-300 group-hover:scale-105">
        ...
        <div className="lg:hidden flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-2 group">
            <div className="w-9 h-9 bg-[#009063] rounded-lg flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-300">
              <span className="text-white font-bold text-lg">S</span>
            </div>
            <span className="text-xl font-bold text-[#3b3b3b]">Stratify</span>
          </Link>

          {/* Mobile Menu Button */}
          <button
            onClick={() => setIsOpen(!isOpen)}
            className="p-2.5 rounded-lg hover:bg-[#dfdcef]/30 transition-all duration-200 border border-[#dfdcef]"
          >
            {isOpen ? <X className="w-5 h-5 text-[#3b3b3b]" /> : <Menu className="w-5 h-5 text-[#3b3b3b]" />}
          </button>
        </div>
      </div>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="lg:hidden bg-[#fbfbfb]/95 backdrop-blur-md border-t border-[#dfdcef] shadow-xl animate-in slide-in-from-top duration-300">
