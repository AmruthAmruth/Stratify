      ...
      <div className="relative z-40 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 sm:pt-12 lg:pt-20 pb-16 sm:pb-20 lg:pb-24">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-tight mb-4 sm:mb-6">
            <span className="block text-text">Get in</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg border-2 border-accent hover:shadow-xl transition-all duration-300 hover:scale-105">
            <div className="w-16 h-16 bg-gradient-to-br from-primary to-primary rounded-2xl flex items-center justify-center mb-6 shadow-md">
              <Mail className="w-8 h-8 text-white" />
            </div>
            <h3 className="text-xl font-bold text-text mb-2">Email Us</h3>
            <p className="text-text/70 mb-4">Our team is here to help</p>
            <a href="mailto:support@stratify.com" className="text-primary font-semibold hover:underline">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg border-2 border-accent hover:shadow-xl transition-all duration-300 hover:scale-105">
            ...
            <p className="text-text/70 mb-4">Mon-Fri from 8am to 5pm</p>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-lg border-2 border-accent hover:shadow-xl transition-all duration-300 hover:scale-105">
            ...
            <p className="text-text/70 mb-4">Come say hello</p>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-2xl border-2 border-accent">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl border-2 border-accent focus:border-primary focus:outline-none transition-colors duration-200"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 rounded-xl border-2 border-accent focus:border-primary focus:outline-none transition-colors duration-200 resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-primary to-primary text-white px-8 py-4 rounded-2xl font-bold text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 flex items-center justify-center space-x-3"
              >
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="space-y-2">
            ...
            <p className="text-text/70 text-sm">We typically respond within 24 hours</p>
          </div>
          <div className="space-y-2">
            <Globe className="w-8 h-8 text-primary mx-auto" />
            <h3 className="font-bold text-text">Global Support</h3>
            <p className="text-text/70 text-sm">Available in 50+ countries worldwide</p>
          </div>
          <div className="space-y-2">
            <MessageSquare className="w-8 h-8 text-primary mx-auto" />
            <h3 className="font-bold text-text">Live Chat</h3>
            <p className="text-text/70 text-sm">Chat with our team in real-time</p>
          </div>
        </div>
      </div>
