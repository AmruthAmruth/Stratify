  ...
  (
    ...
    const initializeFormData = useCallback(() => {
      ...
      fields.forEach((field) => {
        if (field.type === "file") initialData[field.name] = undefined;
            ...
            >
              ...
              {field.type === "select" && field.multiple ? (
                ...
                <div className="space-y-3">
                  <div
                    className="relative rounded-lg border-2 border-dashed border-accent
                    ...
                    {imagePreview[field.name] ? (
                      <div className="relative p-4">
                        <div className="flex items-start gap-4">
                          <div className="relative w-24 h-24 rounded-lg overflow-hidden border border-accent flex-shrink-0">
                            <img
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-muted mt-1">
                              {((formData[field.name] as File)?.size / 1024).toFixed(2)} KB
                            </p>
                            <button
                              type="button"
