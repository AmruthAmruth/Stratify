  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="w-full flex items-center justify-between gap-4 px-8 py-6 bg-transparent hover:bg-accent transition"
      >
        <div>
      ...
      {isOver && canDrop && (
        <div className="absolute inset-0 bg-primary/10 pointer-events-none flex items-center justify-center z-10">
          <div className="bg-surface/95 border-2 border-primary rounded-xl px-6 py-3 shadow-xl">
      ...
      {/* Expanded content */}
      {isExpanded && (
        <div className="p-8 border-t bg-surface">
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-6 text-sm text-text/70">
              <span className="flex items-center gap-2 font-mono bg-surface/50 rounded-lg px-4 py-2 border border-accent/50">
                <time className="text-text font-semibold">
                  {formatDate(sprint.startDate)} → {formatDate(sprint.endDate)}
                </time>
              </span>
              <span className="flex items-center gap-3 font-medium bg-surface/50 rounded-lg px-4 py-2 border border-accent/50">
