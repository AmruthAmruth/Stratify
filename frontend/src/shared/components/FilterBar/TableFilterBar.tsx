...
const TableFilterBar: React.FC<TableFilterBarProps> = ({
  ...
  return (
    <div className="relative">
      {/* Main Container */}
      <div className="bg-surface border border-borderColor rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 p-6 mb-6 relative overflow-hidden">

        {/* Header Section */}
        <div className="flex items-center justify-between mb-5 relative z-10">
          <div className="flex items-center gap-3">
            <div className="w-1.5 h-6 bg-primary rounded-full"></div>
            <h3 className="text-sm font-bold text-heading tracking-wide">TABLE FILTERS</h3>
            {activeFilterCount > 0 && (
          ...
          {onClearFilters && hasActiveFilters && (
            <button
              ...
              className="group px-3 py-1.5 text-xs font-semibold text-muted hover:text-red-600 transition-colors duration-200 flex items-center gap-1.5"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-end relative z-10">
          ...
          <div className="lg:col-span-5">
            <label className="block text-xs font-bold text-heading mb-2 tracking-wide uppercase">
              Search
            </label>
            <div className="relative group">
              ...
              <input
                ...
                className="block w-full pl-10 pr-4 py-3 text-sm text-text placeholder-muted bg-surface border border-borderColor rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200"
              />
              {searchTerm && (
                <button
            ...
            <div className="lg:col-span-3">
              ...
              <div className="relative group">
                <select
                  ...
                  className="block w-full pl-4 pr-10 py-3 text-sm text-text bg-surface border border-borderColor rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all duration-200 cursor-pointer appearance-none"
                >
              ...
              <div className="lg:col-span-3">
                ...
                <div className="relative group">
                  <select
                    ...
                    className="block w-full pl-4 pr-10 py-3 text-sm text-text bg-surface border border-borderColor rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all duration-200 cursor-pointer appearance-none"
                  >
