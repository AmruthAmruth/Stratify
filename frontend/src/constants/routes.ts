...
export const COMPANY_ROUTES = {
  ...
  UPDATE_PROFILE: "/api/company/profile",
};
...
export const PROJECT_ROUTES = {
  ...
  EMPLOYEE_PROJECTS: "/api/project/employee-projects",
  ...
  UPDATE_SPRINT: "/api/project/update-sprint",
  DELETE_SPRINT: (id: string) => `/api/project/delete-sprint/${id}`,
  ASSIGN_TO_SPRINT: "/api/project/assigned-to-sprint",
  PROJECT_LEVEL_ALLOCATION: "/api/project/projectlevel-allocated-employee",
  UPDATE_SUB_TASK: "/api/project/update-sub-task",
  DELETE_SUB_TASK: (id: string) => `/api/project/delete-sub-task/${id}`,
  DELETE_PROJECT: (id: string) => `/api/project/project/${id}`,
  CREATE_ISSUE: "/api/project/create-issue",
  GET_EMPLOYEE_UNDER_PROJECT: (id: string) => `/api/project/issuelevel-allocated-employee/${id}`,
  ...
  ASSINGED_STORY_TO_SPRINT: '/api/project/assign-to-sprint',
  GET_ISSSUES_FOR_EMPLOYEE: '/api/project/issues',
  GET_ISSUES_FOR_MANAGER: '/api/project/manager/issues',
