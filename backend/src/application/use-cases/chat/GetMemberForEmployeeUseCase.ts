...
import { GetMemberForEmployee, MemberDTO } from "../../dto/chat/GetMemberForEmployeeDTO";
import { IGetmemberForEmployeeUseCase } from "../../interfaces/chat/IGetMemberForEmployeeUseCase";

export class GetMemberForEmployeeUseCase implements IGetmemberForEmployeeUseCase {
  constructor(
